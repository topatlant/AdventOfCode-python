...
def get_score(i_play, u_play):
    ...
    scores_outcome = {(I_ROCK, U_ROCK): 3, (I_PAPER, U_PAPER): 3, (I_SCISSORS, U_SCISSORS): 3,
                      (I_ROCK, U_PAPER): 0, (I_ROCK, U_SCISSORS): 6,
                      (I_PAPER, U_ROCK): 6, (I_PAPER, U_SCISSORS): 0,
                      (I_SCISSORS, U_ROCK): 0, (I_SCISSORS, U_PAPER): 6}
    return scores_shape[i_play] + scores_outcome[i_play, u_play]


def get_my_shape(u_play, result):
    strategy = {(U_ROCK, I_DRAW): I_ROCK, (U_PAPER, I_DRAW): I_PAPER, (U_SCISSORS, I_DRAW): I_SCISSORS,
                (U_ROCK, I_WIN): I_PAPER, (U_ROCK, I_LOSE): I_SCISSORS,
                (U_PAPER, I_WIN): I_SCISSORS, (U_PAPER, I_LOSE): I_ROCK,
                (U_SCISSORS, I_WIN): I_ROCK, (U_SCISSORS, I_LOSE): I_PAPER}
